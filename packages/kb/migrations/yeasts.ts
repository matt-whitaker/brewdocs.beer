...
import type {KbYeast} from "../src/models";

// v0 is any yeast cached before the kb started stamping `version` at all —
...
const yeastsV0ToV1: Migration<KbYeast> = {
    namespace: "kb.yeasts",
    from: 0,
    to: 1,
