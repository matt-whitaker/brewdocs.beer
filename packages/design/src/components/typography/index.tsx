...
export const ScreenH1 = ({ children, className }: TypographyProps) =>
    (<h1 className={classNames("text-2xl capitalize -mx-2 px-2 py-1 mt-5 first:mt-0 [&+h2]:mt-0 bg-primary/60 rounded-full", [className])}>{children}</h1>);
...
export const ScreenH3 = ({ children, className }: TypographyProps) =>
    (<h3 className={classNames("text-xl capitalize mt-3 [&.cozy]:mt-0 [&+h3]:mt-0 [&+h4]:mt-1 leading-tight", [className])}>{children}</h3>);

export const ScreenH4 = ({ children, className }: TypographyProps) =>
    (<h4 className={classNames("text-md capitalize font-semibold mt-2 [&.cozy]:mt-0 [&+h5]:mt-0 [&+h4]:mt-0 leading-tight", [className])}>{children}</h4>);

export const ScreenH5 = ({ children, className }: TypographyProps) =>
    (<h5 className={classNames("capitalize mt-1 [&.cozy]:mt-0", [className])}>{children}</h5>);
