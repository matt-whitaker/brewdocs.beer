...
**BATCH-SHOPPING-02** — Rows are grouped under headings for the four ingredient categories —
Hops, Grains, Yeasts, Additives — and each group can be collapsed and expanded on its own.

**BATCH-SHOPPING-03** — Rows can be sorted by type (grouped under the four category headings),
by name (one alphabetical list, no group headings), or by purchased state (a "To buy" group
and a "Purchased" group).
...
**BATCH-SHOPPING-06** — A brewer can add their own item to the Shopping list, naming it and
choosing which of the four categories — Hops, Grains, Yeasts, Additives — it belongs under.
