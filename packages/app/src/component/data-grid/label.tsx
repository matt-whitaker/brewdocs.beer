...
const LABEL_CLASS = "text-sm whitespace-nowrap leading-6 lg:leading-8 has-[input]:hover:cursor-pointer col-span-4 [.data-grid_.data-grid_&]:text-2xs [.data-grid_.data-grid_&]:pl-3";
