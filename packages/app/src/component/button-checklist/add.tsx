...
export type ButtonChecklistAddProps = { add: (batch: Batch) => void }
export default function ButtonChecklistAdd({ add }: ButtonChecklistAddProps) {
    ...
    return (
        <li className="pl-1 w-full overflow-hidden max-lg:[&>label]:odd:btn-ghost flex items-center flex-grow pr-1">
            ...
            <TextInput onChange={add} className="input lg:input-sm input-xs lg:input-primary max-lg:input-ghost flex-grow ml-2 outline-0" />
        </li>
    )
}