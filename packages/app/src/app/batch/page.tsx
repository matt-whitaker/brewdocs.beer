...
export default function BatchPage() {
    ...
    if (!batch || !recipe || !settings) return <Loading />;
    ...
    return (
        <PanelSwitcher>
            ...
            <PanelSwitcherContent active={active} change={setActive} title="Checklists">
                <Shopping batch={batch} recipe={recipe} settings={settings} onChange={onChange} />
                <BatchChecklist batch={batch} settings={settings} onChange={onChange} />
            </PanelSwitcherContent>
