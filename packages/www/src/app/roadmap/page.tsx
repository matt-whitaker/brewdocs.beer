        ...
        <Hero title="Roadmap" className="max-lg:pt-16 overflow-hidden">
            ...
            <div className="max-w-screen-lg content-start grid-flow-col lg:columns-5 columns-2 lg:w-full mt-4">
                {roadmap.map(([item, done]) => (
                    <label title={item} className="box-border lg:py-2 py-1 flex items-center justify-start lg:text-md text-sm overflow-hidden whitespace-nowrap overflow-ellipsis">
