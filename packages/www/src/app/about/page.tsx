    ...
    return (
        <Hero title="About BrewDocs" className="max-lg:pt-16">
            <div className="lg:max-w-screen-md p-4 text-left [&>p]:mt-3 [&>p]:indent-4 lg:text-lg flex flex-col">
                ...
                <p>Additionally, the software follows an <b>offline-first</b> approach. The aim is to provide fast, on-demand information as well as keeping operating costs down.</p>
