export const SRM_TO_HEX = new Map<number, [string, string, string]>([
    ...
    [9,  ["bg-beer-9",  "border-beer-9", "outline-beer-9"]],   // Deep Gold
    [12, ["bg-beer-12", "border-beer-12", "outline-beer-12"]],  // Light Amber
    [15, ["bg-beer-15", "border-beer-15", "outline-beer-15"]],  // Amber
    [18, ["bg-beer-18", "border-beer-18", "outline-beer-18"]],  // Deep Amber
    [20, ["bg-beer-20", "border-beer-20", "outline-beer-20"]],  // Copper
    [24, ["bg-beer-24", "border-beer-24", "outline-beer-24"]],  // Deep Copper
